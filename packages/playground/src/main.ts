...
async function main() {
  //creating a workspace, toplevel container which contains pages.
  // We can register a batch of blocks to the workspace with register fn.
  const workspace = new Workspace(options)
    .register(AffineSchemas)
    .register(__unstableSchemas);

  // setting up some global variables so that they can be accessed from anywhere
  ...
  //initiates the connection by setting websocket for collaboration work.
  workspace.connect();
